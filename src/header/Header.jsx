    ...
    return (
       <header className="bg-gray-700">
            <div className="navbar container mx-auto px-10 py-3 flex-col lg:flex-row">
                ...
                <div className="navbar-end my-5 lg:my-0">
                    <Link to={'/login'} className="btn mr-4 py-2 px-5 capitalize h-auto min-h-0">Log in</Link>
                    <Link to={'/register'} className="btn py-2 px-5 capitalize h-auto min-h-0">Register</Link>
                </div>
            </div>
       </header>
    );
